...
class StokOpnamePolicy
{
    ...
    {
        return $user->can('view_any_stok::opname');
    }
    ...
    {
        return $user->can('view_stok::opname');
    }
    ...
    {
        return $user->can('create_stok::opname');
    }
    ...
    {
        return $user->can('update_stok::opname');
    }
    ...
    {
        return $user->can('delete_stok::opname');
    }
    ...
    {
        return $user->can('delete_any_stok::opname');
    }
     ...
     */
    public function replicate(User $user, StokOpname $stokOpname): bool
    {
