...
class CustomerKategoriPolicy
{
    ...
    {
        return $user->can('view_any_customer::kategori');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, CustomerKategori $customerKategori): bool
    {
        return $user->can('view_customer::kategori');
    }
    ...
    {
        return $user->can('create_customer::kategori');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, CustomerKategori $customerKategori): bool
    {
        return $user->can('update_customer::kategori');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, CustomerKategori $customerKategori): bool
    {
        return $user->can('delete_customer::kategori');
    }
    ...
    {
        return $user->can('delete_any_customer::kategori');
    }
