...
class PencatatanKeuanganPolicy
{
    ...
    {
        return $user->can('view_any_laporan::pembayaran::supplier');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, PencatatanKeuangan $pencatatanKeuangan): bool
    {
        return $user->can('view_laporan::pembayaran::supplier');
    }
    ...
    {
        return $user->can('create_laporan::pembayaran::supplier');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, PencatatanKeuangan $pencatatanKeuangan): bool
    {
        return $user->can('update_laporan::pembayaran::supplier');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, PencatatanKeuangan $pencatatanKeuangan): bool
    {
        return $user->can('delete_laporan::pembayaran::supplier');
    }
    ...
    {
        return $user->can('delete_any_laporan::pembayaran::supplier');
    }
